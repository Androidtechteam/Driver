...
import com.cab.driver.common.helper.Constants.notificationIcon
...
class TrackingService : Service() {
    ...
    override fun onCreate() {
        ...
        mFirebaseDatabaseRequest = mFirebaseInstance.getReference(applicationContext.getString(com.cab.driver.R.string.real_time_db))
