package com.cab.driver.home.pushnotification
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (SinchHelpers.isSinchPushPayload(remoteMessage.data)) {
            ...
            /*NotificationResult result = CabmeSinchService.sinchClient.relayRemotePushNotificationPayload(remoteMessage.getData());*/
            initSinchService()
        } else {
