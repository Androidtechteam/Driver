...
import com.cab.driver.common.helper.Constants.RequestEndTime
...
import com.cab.driver.common.util.CommonMethods.Companion.startFirebaseChatListenerService
import com.cab.driver.common.util.CommonMethods.Companion.stopFirebaseChatListenerService
import com.cab.driver.common.util.Enums
import com.cab.driver.common.util.Enums.REQ_DEVICE_STATUS
import com.cab.driver.common.util.Enums.REQ_DRIVER_PROFILE
import com.cab.driver.common.util.Enums.REQ_DRIVER_STATUS
import com.cab.driver.common.util.Enums.REQ_UPDATE_ONLINE
...
class MainActivity : CommonActivity(), ServiceListener {
    ...
    * */
    ...
    override fun onSuccess(jsonResp: JsonResponse, data: String) {
        ...
        Log.i(TAG, "onSuccess: requestCode=${jsonResp.requestCode}")
        Log.i(TAG, "onSuccess: statusMsg=${jsonResp.statusMsg}")
        Log.i(TAG, "onSuccess: statusCode=${jsonResp.statusCode}")
        Log.i(TAG, "onSuccess: isSuccess=${jsonResp.isSuccess}")
        Log.i(TAG, "onSuccess: Data2=$data")
        Log.i(TAG, "====================================================================")
