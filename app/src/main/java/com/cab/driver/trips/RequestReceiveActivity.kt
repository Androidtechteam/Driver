...
import com.cab.driver.common.helper.CircularMusicProgressBar
import com.cab.driver.common.helper.CustomDialog
import com.cab.driver.common.helper.WaveDrawable
...
import com.cab.driver.trips.timelineview.LocationTimeLineView
...
class RequestReceiveActivity : CommonActivity(), LinearTimer.TimerListener, ServiceListener, OnMapReadyCallback {
    ...
    */
    override fun timerTick(tickUpdateInMillis: Long) {
        ...
        mPlayer = MediaPlayer.create(this, R.raw.cabme)
        mPlayer.start()
