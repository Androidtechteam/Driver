...
import com.cab.driver.common.util.Enums.REQ_CASH_COLLECTED
import com.cab.driver.common.util.Enums.REQ_GET_INVOICE
...
class PaymentAmountPage : CommonActivity(), ServiceListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setTextColor(ContextCompat.getColor(this, R.color.cabme_app_black))
   ...
   */
    fun loaddata() {
        ...
        if (CommonKeys.TripStatus.Completed == payment_status) {
            button.setTextColor(resources.getColor(R.color.cabme_app_black))
